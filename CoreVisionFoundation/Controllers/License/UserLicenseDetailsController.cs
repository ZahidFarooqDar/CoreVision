...
namespace CoreVisionFoundation.Controllers.License
{
    ...
    public class UserLicenseDetailsController : ApiControllerWithOdataRoot<UserLicenseDetailsSM>
    {
        ...
        [HttpGet("{id}")]
        [Authorize(AuthenticationSchemes = CoreVisionBearerTokenAuthHandlerRoot.DefaultSchema, Roles = "ClientAdmin, ClientEmployee,SystemAdmin,SuperAdmin")]
        ...
        [Authorize(AuthenticationSchemes = CoreVisionBearerTokenAuthHandlerRoot.DefaultSchema, Roles = "ClientAdmin, ClientEmployee,SuperAdmin,SystemAdmin")]
