...
namespace CoreVisionBAL.AppUsers
{
    public partial class ClientUserProcess : LoginUserProcess<ClientUserSM>
    {
        ...
        /*#region Check new User to add

        public async Task<BoolResponseRoot?> CheckNewUserToAdd(ClientUserSM signUpSM, string companyCode)
        {
            if (signUpSM == null)
            {
                throw new CodeVisionException(ApiErrorTypeSM.InvalidInputData_NoLog, "Please provide details for Sign Up", "Please provide details for Sign Up");
            ...
            {
                //Todo: Login id here
                signUpSM.LoginId = null;
                //return new BoolResponseRoot(true, "user is already present with the loginId");
            }
            ...
            using (var transaction = await _apiDbContext.Database.BeginTransactionAsync())
            {
                ...
                if (signUpSM.ClientUserAddressId == default || signUpSM.ClientUserAddressId == 0)
                {
                    objDM.ClientUserAddressId = null;
                }
                ...
                objDM.CreatedBy = _loginUserDetail.LoginId;
                objDM.CreatedOnUTC = DateTime.UtcNow;
                //Todo: Check whether to confirm these details (EmailConfirmed, Phone Confirmed, LoginStatus
        ...
        #endregion Check new User to add*/
