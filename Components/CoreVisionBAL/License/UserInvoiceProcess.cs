...
namespace CoreVisionBAL.License
{
    public class UserInvoiceProcess : CoreVisionBalOdataBase<UserInvoiceSM>
    {
        ...
        public override async Task<IQueryable<UserInvoiceSM>> GetServiceModelEntitiesForOdata()
        {
            ...
            IQueryable<UserInvoiceSM> retSM = await base.MapEntityAsToQuerable<UserInvoiceDM, UserInvoiceSM>(_mapper, entitySet);
            return retSM;
        }
        ...
        public async Task<List<UserInvoiceSM>>GetMineInvoices(int userId)
        {
            ...
            {
                throw new CoreVisionException(ApiErrorTypeSM.Fatal_Log, "No Invoices Found", "No Invoices Found");
            }
        ...
        public async Task<UserInvoiceSM?> GetUserInvoiceById(int Id)
        {
            ...
            {
                throw new CoreVisionException(ApiErrorTypeSM.Fatal_Log, @$"{ex.Message}", @"Could not get user invoice, please try again", ex.InnerException);
            }
        }
        ...
        public async Task<UserInvoiceSM?> AddUserInvoice(UserInvoiceSM userInvoiceSM)
        {
            ...
            {
                throw new CoreVisionException(ApiErrorTypeSM.Fatal_Log, @$"{ex.Message}", @"Could not add user invoice, please try again", ex.InnerException);
            }
        ...
        public async Task<UserInvoiceSM?> UpdateUserInvoice(int objIdToUpdate, UserInvoiceSM userInvoiceSM)
        {
            ...
            {
                throw new CoreVisionException(ApiErrorTypeSM.Fatal_Log, @$"{ex.Message}", @"Could not user invoice, please try again", ex.InnerException);
            }
            return null;
        }
        ...
        public async Task<string> GetInvoiceContextFromStripe(string stripeInvoiceId)
        {
            try
            {
                ...
                {
                    throw new CoreVisionException(ApiErrorTypeSM.Fatal_Log, "No invoice found for the provided invoice ID.", "No invoice found for the provided invoice ID.");
                }
